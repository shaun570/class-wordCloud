...
function simpleWordAnalysis(text: string): WordWeight[] {
  ...
  const geoWords = new Set([
    '中国', '世界', '亚洲', '欧洲', '美洲', '非洲', '大洋洲', '南极洲',
    '国家', '省份', '城市', '城镇', '乡村', '河流', '湖泊', '海洋', '海域',
    '山脉', '高原', '平原', '盆地', '丘陵', '沙漠', '森林', '草原', '湿地',
    '气候', '气温', '降水', '风向', '季节', '天气', '温度', '热带', '温带', '寒带',
    '地形', '地貌', '地势', '海拔', '资源', '能源', '矿产', '石油', '天然气',
    '人口', '经济', '文化', '地理', '地图', '经度', '纬度', '赤道', '极地',
    '陆地', '岛屿', '半岛', '海峡', '海湾', '海岸', '港口', '首都', '地区',
    '边界', '领土', '大陆', '瀑布', '火山', '地震', '板块', '农业', '工业',
    '交通', '贸易', '旅游', '环境', '生态', '保护', '污染', '可持续发展',
  ...
  const eduWords = new Set([
    ...
    '知识', '考试', '测验', '作业', '复习', '预习', '练习', '培训', '教育',
    '大学', '学院', '小学', '中学', '高中', '职业', '专业', '学科', '教材',
    '课本', '笔记', '阅读', '写作', '理解', '掌握', '技能', '能力', '方法',
